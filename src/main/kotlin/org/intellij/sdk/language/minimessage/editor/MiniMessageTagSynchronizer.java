...
public class MiniMessageTagSynchronizer implements EditorFactoryListener {

    private static final Key<Boolean> SKIP_COMMAND = Key.create("tag.name.synchronizer.skip.command");
    private static final Logger LOG = Logger.getInstance(MiniMessageTagSynchronizer.class);
    private static final Set<Language> SUPPORTED_LANGUAGES = Set.of(MiniMessageLanguage.INSTANCE, NanoMessageLanguage.INSTANCE);

    private static final Key<TagNameSynchronizer> SYNCHRONIZER_KEY = Key.create("tag_name_synchronizer");

    private MiniMessageTagSynchronizer() { }
