...
import com.intellij.psi.xml.*;import org.intellij.sdk.language.minimessage.MiniMessageTokenType;
...
<TAG_ATTRIBUTES> ":" { yybegin(ATTRIBUTE_VALUE_START); return MiniMessageTokenType.MM_ATTRIBUTE_SEPARATOR; }
...
<ATTRIBUTE_VALUE_START> [^:'\"\>]([^:\>]|(\/[^\>]))* { yybegin(TAG_ATTRIBUTES); return XmlTokenType.XML_ATTRIBUTE_VALUE_TOKEN; }
